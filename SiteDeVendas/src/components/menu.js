...
import { AppBar, Toolbar, Typography, Button, Drawer, List, ListItem, ListItemButton, IconButton, Divider } from '@mui/material';
    ...
    <div>
      ...
      >
        <div style={{ width: 250, height: '100%' }}>
          ...
          {/* Divider para separar as seções (Linha discreta e mais fina) */}
          <Divider sx={{ borderColor: 'rgba(255, 255, 255, 0.3)', my: 1, borderWidth: 0.25 }} />

          {/* Lista de links (Produtos, Listar Produto) */}
          <List>
          ...
          {/* Lista de links (Categoria, Listar Categoria) */}
          <List>
          ...
          {/* Lista de links (Venda, Listar Vendas) */}
          <List>
            ...
            <ListItem button>
              <ListItemButton
                sx={{
                  textTransform: 'none',
                  color: 'white',
                  backgroundColor: '#ff4d4d', // Tom de vermelho mais suave
                  borderRadius: '20px', // Arredondando os cantos
                  padding: '10px 20px', // Tamanho adequado para o botão
                  '&:hover': {
                    backgroundColor: '#ff2a2a', // Cor do hover mais escura
                  },
                }}
                component={Link}
                to="/limparTabelas"
